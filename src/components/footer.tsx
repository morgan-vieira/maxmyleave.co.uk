...
export function Footer() {
    return (
        <footer
            ...
            style={{ backgroundColor: 'rgb(var(--surface-soft) / 0.85)', borderColor: 'rgb(var(--border))' }}
        >
            <div className="container mx-auto px-4 py-10">
                <div className="flex flex-col gap-8 md:flex-row md:items-start md:justify-between">
                    <div className="space-y-3 max-w-md">
                        <p className="text-sm font-medium italic lowercase tracking-wide transition-colors duration-[400ms]" style={{ color: 'rgb(var(--foreground))' }}>
                            maxmyleave
                        </p>
                        <p className="text-sm italic transition-colors duration-[400ms]" style={{ color: 'rgb(var(--muted-foreground))' }}>
                ...
                <div className="mt-10 flex flex-col gap-2 text-xs italic md:flex-row md:items-center md:justify-between">
                    <span className="transition-colors duration-[400ms]" style={{ color: 'rgb(var(--muted-foreground))' }}>
